...
// node_modules/@almothafar/angular-signature-pad/fesm2022/almothafar-angular-signature-pad.mjs
var SignaturePadComponent = class _SignaturePadComponent {
  constructor() {
  ...
  redrawCanvas() {
    const canvas = this.getCanvas();
    const ratio = Math.max(window.devicePixelRatio || 1, 1);
    const baseWidth = this.options.canvasWidth ? this.options.canvasWidth - 2 : this._getWidthFix(canvas);
    const baseHeight = this.options.canvasHeight ? this.options.canvasHeight - 2 : this._getHeightFix(canvas);
  ...
  static {
    this.ɵfac = function SignaturePadComponent_Factory(__ngFactoryType__) {
      return new (__ngFactoryType__ || _SignaturePadComponent)();
    };
  }
  static {
    this.ɵcmp = ɵɵdefineComponent({
      type: _SignaturePadComponent,
      ...
      styles: ["[_nghost-%COMP%]{background:#faebd7;display:flex;align-items:center;justify-content:center}[_nghost-%COMP%]   .signature-pad-canvas[_ngcontent-%COMP%]{border:1px solid gray}"]
    });
  }
};
(() => {
  (typeof ngDevMode === "undefined" || ngDevMode) && setClassMetadata(SignaturePadComponent, [{
    ...
    args: [{
      ...
      standalone: true,
      styles: [":host{background:#faebd7;display:flex;align-items:center;justify-content:center}:host .signature-pad-canvas{border:1px solid gray}\n"]
    }]
  }], () => [], {
    options: [{
      type: Input

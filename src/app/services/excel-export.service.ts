...
export class ExcelExportService {
  ...
  /**
   * Exporta datos a Excel PRESERVANDO 100% de los estilos originales
   * Incluye: colores, bordes, imágenes, logotipos, tamaños de fuente, etc.
   */
  /**
  ...
  private procesarHoja(worksheet: ExcelJS.Worksheet, formData: any): void {
    ...
    // this.setCell(worksheet, 'B4', formData.placa); // Placa
